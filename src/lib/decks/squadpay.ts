...
export const squadpayDeck: Deck = {
  ...
  slides: [
    ...
    },
    {
      ...
      body: "Tested with 12 known people. Real-user testing confirmed the social friction around asking friends for repayment, that participants wanted to check AI-extracted receipt data before relying on it, and that all 12 expected integrated UPI/payment functionality.",
      stats: [
      ...
      note: "12 known people, not a statistically representative sample. UPI/GPay integration remains a requested, deferred next step — it wasn't implemented in the tested version. 3/12 reported an extraction issue where not all dishes were added.",
    },
    {
      kind: "takeaway",
